...
Before training and testing it, we test **different hyperparameter values** in order to find the best ones and train the model using them. We are going to test different values of:
- Training epochs
- Hidden neurons
- Hidden layers
- Learning rate
